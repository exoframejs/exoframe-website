---
path: '/docs/server-installation'
date: '2020-05-17T10:10:00Z'
title: 'Exoframe Server'
categories: ['Exoframe', 'tutorial']
tags: ['example']
excerpt: 'Pull and run Exoframe server using docker'
---
...
3.  Edit config file to fit your needs (see [Server Configuration](/docs/server-configuration) section)
...
1.  Make sure you have Docker [installed and running](https://docs.docker.com/engine/installation/) on your host.
2.  Create exoframe config file and enable `letsencrypt` in it (see [Server Configuration](/docs/server-configuration) section)
